    ...
    <div class="page-container">
        ...
        <DraggableModal title="淹没分析">
            <div class="row" style="justify-content:center;">
                <el-button @click="drawInundationRegion" :color="isDraw?'red':'greenyellow'" class="draw-button" round>绘制</el-button>
            </div>
            <div class="row">
...
const onMapReady=(cesiumViewer:Cesium.Viewer)=>{
    ...
    initCesiumBase(viewer,{
        destination:{lng: 114.4074049,lat: 30.507212,height:1000},
