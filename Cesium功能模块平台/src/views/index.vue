  ...
  <div class="home-page">
    <section class="hero-section">
      ...
      <div class="hero-content">
        <div class="brand-row">
          <img class="brand-logo" :src="logo" alt="中图软件" />
          <div>
            <div class="brand-name">中图软件</div>
    ...
    <main class="home-main">
      ...
      <section class="content-section">
        <div class="section-head">
          ...
          <el-button text type="primary" @click="openPage('/cesium-function/default/default-imagery', 'Cesium 功能')">
            进入三维场景
        ...
        <div class="feature-grid">
          <article
            v-for="item in featuredCesiumItems"
            :key="item.name"
            class="feature-card"
            tabindex="0"
