<template>
    <div class="page-container">
        ...
        <DraggableModal title="可视域分析（地形）">
            <div class="row">
                <el-button class="draw-button" round :color="drawState === 'idle' ? '#16a34a' : '#f97316'"
                    :disabled="isAnalyzing" @click="toggleDraw">
            ...
            <div class="row">
                ...
                <el-input-number v-model="analysisRadius" class="input" :min="10" :max="10000" :step="100"
                    :disabled="isAnalyzing" />
            </div>

            <div class="row">
                <span class="label">视场角</span>
                <el-input-number v-model="analysisFov" class="input" :min="10" :max="360" :step="5"
                    :disabled="isAnalyzing" />
            </div>

            <div class="row button-row">
                <el-button class="button" color="#1E88E5" :loading="isAnalyzing" :disabled="isAnalyzing"
                    @click="runAnalysis">
                    开始分析
                </el-button>
