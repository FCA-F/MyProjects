<template>
  <div class="page-container">
    ...
    <DraggableModal title="GeoJSON绘制与导出">
        <div class="drawToolbar">
            <el-select v-model="drawingMode" style="width:250px;height:30px" placeholder="绘制类型">
                <el-option
        ...
        <el-button @click="exportEntities()" color="#1E88E5">导出数据</el-button>
    </DraggableModal>
  </div>
</template>
