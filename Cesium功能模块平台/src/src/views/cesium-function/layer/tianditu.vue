...
const loadImagery = () => {
    const imageryLayer = new Cesium.WebMapTileServiceImageryProvider({
        url: `http://t0.tianditu.gov.cn/${imageryType.value}_w/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=${imageryType.value}&STYLE=default&TILEMATRIXSET=w&FORMAT=tiles&tk=${tianditu_Token}`,
        layer: imageryType.value,
        style: 'default',
        format: 'tiles',
        tileMatrixSetID: 'w',
        maximumLevel: 18,
