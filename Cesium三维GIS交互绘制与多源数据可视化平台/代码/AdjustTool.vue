<template>
    ...
    <div class="adjustDiv">
        ...
        <input type="range" v-model.number="height" min="-500" max="500" step="1"><br>
        <input type="text" v-model.number="height"><br>
    <!--旋转-->
        <label style="color:white">X轴旋转</label><br>
        <input type="range" v-model.number="rx" min="-100" max="100" step="1">
        <input type="text" v-model.number="rx"><br>
        <label style="color:white">Y轴旋转</label><br>
        <input type="range" v-model.number="ry" min="-100" max="100" step="1">
        <input type="text" v-model.number="ry"><br>
        <label style="color:white">Z轴旋转</label><br>
        <input type="range" v-model.number="rz" min="-100" max="100" step="1">
        <input type="text" v-model.number="rz"><br>
    <!--平移-->
        <label style="color:white">经度平移</label><br>
        <input type="range" v-model.number="tLon" min="-100" max="100" step="1">
        <input type="text" v-model.number="tLon"><br>
        <label style="color:white">维度平移</label><br>
        <input type="range" v-model.number="tLat" min="-100" max="100" step="1">
        <input type="text" v-model.number="tLat"><br>
    <!--缩放-->
        <label style="color:white">缩放</label><br>
        <input type="range" v-model.number="scale" min="0.1" max="10" step="0.01">
