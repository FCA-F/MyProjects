<template>
  ...
  <div class="left-toolbar">
    ...
    <VisibilityAnalysis v-if="osmBuildingTile" :viewer="viewer!"/>
...
import VisibilityAnalysis from './components/VisibilityAnalysis.vue'
...
const terrain=ref<Cesium.TerrainProvider>();
const osmBuildingTile=ref<Cesium.Cesium3DTileset>();
const annotations=ref<Cesium.LabelCollection>();
